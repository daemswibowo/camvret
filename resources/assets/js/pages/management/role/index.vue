				...
				<div class="modal-content">
					...
					<form action="javascript:void(0)" novalidate @submit.prevent="onSubmit">
						...
						<div class="modal-footer">
							...
							<button type="submit" :disabled="loadings.submit || loadings.permissions" class="btn btn-primary">Simpan</button>
						</div>
					</form>
				</div>
			</div>
				...
				<div class="card card-accent-primary">
					<div class="card-header">
						...
						<div class="card-header-actions">
							<a v-if="can('Delete Roles') && selectedItems.length>0" href="javascript:void(0)" @click="selectedItems=[]" has-tooltip="true" data-placement="top" title="Batalkan Seleksi" class="card-header-action btn-setting">
								<i class="icon-close"></i> Batalkan seleksi
							</a>
							<a v-if="can('Delete Roles') && selectedItems.length>0" href="javascript:void(0)" @click="massDelete" has-tooltip="true" data-placement="top" title="Hapus item yang dipilih" class="card-header-action btn-setting text-danger">
								<i class="icon-trash"></i> Hapus
							</a>
							<a v-if="can('Create Roles')" href="javascript:void(0)" @click="create" has-tooltip="true" data-placement="top" title="Tambah" class="card-header-action btn-setting">
								<i class="icon-plus"></i>
							</a>
